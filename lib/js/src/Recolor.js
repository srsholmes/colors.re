...
function recolor(color, modifier, keywordOptions, str) {
  return changeColor$1(color, keywordOptions, doModifier(modifier, highlightKeyword(keywordOptions, str)));
}

var myString = recolor(/* Some */[/* Red */0], /* Some */[/* Bold */1], /* Some */[/* record */[
        /* colorType : Blue */3,
        /* word */"my"
      ]], "this is my string");
