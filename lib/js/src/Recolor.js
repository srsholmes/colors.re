...
function keyword(keyword$1, str, color) {
  var containsString = +str.includes(keyword$1);
  if (containsString !== 0) {
    return str.split(" ").map((function (x) {
                    var match = +(x === keyword$1);
                    if (match !== 0) {
...
function recolor(color, modifier, _, str) {
  if (color) {
    var c = color[0];
    if (modifier) {
...
var myTester = keyword("hello", "hello world hello", /* Yellow */1);
